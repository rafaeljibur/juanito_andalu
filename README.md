...
## Como use usa? / How to use?
1: Clonarte el repositorio en tu sistema  con la herramienta con git clone y este enlace https://github.com/rafaeljibur/juanito_andalu.git
